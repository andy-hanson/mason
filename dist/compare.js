...
define(["exports","./Boolean","./js","./Type/Method","./at/at","./at/at-Type","./at/q","./at/Seq/Arraybang","./at/Seq/Seq","./control","./Function","./Object","./Type/Pred-Type","./bang","./at/at","./at/q","./at/at-Type","./Try"],function(exports,Boolean_0,js_1,Method_2,_64_3,_64_45Type_4,_63_5,Array_33_6,Seq_7,control_8,Function_9,Object_10,Pred_45Type_11,_33_12,_64_13,_63_14,_64_45Type_15,Try_16){
	exports._get=_ms.lazy(function(){
		...
		}),_$10=_ms.lazyGetModule(Seq_7),first=_ms.lazyProp(_$10,"first"),tail=_ms.lazyProp(_$10,"tail"),_$11=_ms.lazyGetModule(control_8),_if=_ms.lazyProp(_$11,"if"),if_33=_ms.lazyProp(_$11,"if!"),opr=_ms.lazyProp(_$11,"opr"),returning=_ms.lazyProp(_$11,"returning"),_$12=_ms.lazyGetModule(Function_9),identity=_ms.lazyProp(_$12,"identity"),_$13=_ms.lazyGetModule(Object_10),object_61_63=_ms.lazyProp(_$13,"object=?"),_$14=_ms.lazyGetModule(Pred_45Type_11),Opt=_ms.lazyProp(_$14,"Opt"),_33=_ms.lazy(function(){
					...
					return function(){
						...
						loop119:while(true){
							...
							if(_ms.bool(done)){
								...
								_ms.unlazy(if_33)(_60_63(cur_45max_45by,value_45by),function(){
									cur_45max=value;
		...
		const sorted_63=exports["sorted?"]=function(){
			...
			return _ms.set(function sorted_63(seq,_63sort_45by){
		...
		const sort=exports.sort=Method(function(){
			...
			const _default=function _default(_,_63sort_45by){
				const sort_45by=_ms.unlazy(opr)(_63sort_45by,_ms.unlazy(identity));
...
//# sourceMappingURL=data:application/json;base64,