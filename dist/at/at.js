		...
		const keep_39 = exports["keep'"] = function() {
			...
			return _ms.set(function(_, keep_45if_63) {
				...
				return _ms.unlazy(Stream)(function*() {
					const iter = iterator(_);
					loop171: while (true) {
						const _$172 = iter.next(), value = _$172.value, done = _$172.done;
						switch (true) {
							case _ms.bool(done):
								{
									break loop171
		...
		const map_39 = exports["map'"] = function() {
			...
			return _ms.set(function(_, mapper) {
				...
				return _ms.unlazy(Stream)(function*() {
					const iter = iterator(_);
					loop196: while (true) {
						const _$197 = iter.next(), value = _$197.value, done = _$197.done;
						switch (true) {
							case _ms.bool(done):
								{
									break loop196
		...
		const fold_45map = exports["fold-map"] = function() {
			...
			return _ms.set(function(_, start, mapper_45folder) {
				...
				const mapped = _61_62(Array, map(_, function(em) {
					const _$219 = mapper_45folder(_ms.unlazy(get)(acc), em), here = _ms.checkContains(Any, _$219.here, "here"), next = _ms.checkContains(Any, _$219.next, "next");
		...
		const flat_45map_39 = exports["flat-map'"] = function() {
			...
			return _ms.set(function(_, mapper) {
				...
				return _ms.unlazy(Stream)(function*() {
					const iter = iterator(_);
					loop247: while (true) {
						const _$248 = iter.next(), value = _$248.value, done = _$248.done;
						switch (true) {
							case _ms.bool(done):
								{
									break loop247
...
//# sourceMappingURL=data:application/json;base64,