...
define(["exports","../../at/at","../../at/atbang","../../at/at-Type","../../at/Seq/Arraybang","../../at/Seq/Range","../../at/Seq/Seqbang","../../at/Seq/Stream","../../at/Set/Id-Setbang","../../compare","../../control","../../js","../../math/Number","../../math/methods","../../Type/Type","../../at/Seq/Seq"],function(exports,_64_0,_64_33_1,_64_45Type_2,Array_33_3,Range_4,Seq_33_5,Stream_6,Id_45Set_33_7,compare_8,control_9,js_10,Number_11,methods_12,Type_13,Seq_14){
	exports._get=_ms.lazy(function(){
		...
		const happy_45numbers=_ms.checkContains(_ms.sub(Stream,Nat),function(){
			...
			const test=built.test=function test(){
				_ms.assert(_ms.unlazy(seq_61_63),_ms.unlazy(take)(happy_45numbers,8),function(){
					const built=[];
					_ms.add(built,1);
					_ms.add(built,7);
					_ms.add(built,10);
...
//# sourceMappingURL=data:application/json;base64,