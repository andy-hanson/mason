...
define(["exports","./at/at","./Function","./Generatorbang","./methods","./Type/Method","./Type/Pred-Type","./Type/Type","./io/time","./Try","./bang","./compare","./math/Number","./math/methods","./Try"],function(exports,_64_0,Function_1,Generator_33_2,methods_3,Method_4,Pred_45Type_5,Type_6,time_7,Try_8,_33_9,compare_10,Number_11,methods_12,Try_13){
	exports._get=_ms.lazy(function(){
		const _64=_ms.getDefaultExport(_64_0),_$2=_ms.getModule(_64_0),flatten=_ms.get(_$2,"flatten"),_$3=_ms.getModule(Function_1),apply=_ms.get(_$3,"apply"),Thunk=_ms.get(_$3,"Thunk"),Generator_33=_ms.getDefaultExport(Generator_33_2),_$5=_ms.getModule(methods_3),sub=_ms.get(_$5,"sub"),_$6=_ms.getModule(Method_4),self_45impl_33=_ms.get(_$6,"self-impl!"),_$7=_ms.getModule(Pred_45Type_5),Any=_ms.get(_$7,"Any"),_$8=_ms.getModule(Type_6),_61_62=_ms.get(_$8,"=>"),_$10=_ms.lazyGetModule(time_7),$after_45time=_ms.lazyProp(_$10,"$after-time"),_$11=_ms.lazyGetModule(Try_8),$catch=_ms.lazyProp(_$11,"$catch"),_33=_ms.lazy(function(){
			return _ms.getDefaultExport(_33_9)
		}),_$14=_ms.lazyGetModule(compare_10),_61_63=_ms.lazyProp(_$14,"=?"),_$15=_ms.lazyGetModule(Number_11),divisible_63=_ms.lazyProp(_$15,"divisible?"),_$16=_ms.lazyGetModule(methods_12),_43=_ms.lazyProp(_$16,"+"),_$17=_ms.lazyGetModule(Try_13),$try=_ms.lazyProp(_$17,"$try");
		const $=function(){
			const built={};
...
//# sourceMappingURL=data:application/json;base64,